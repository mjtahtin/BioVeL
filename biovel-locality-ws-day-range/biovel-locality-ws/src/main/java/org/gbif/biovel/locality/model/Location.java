...
public class Location implements Comparable<Location>{
  ...
  public boolean isLocationNull(int x)
  {
    ...
    //Check if has no letters
    String locationStr = getLocationString(0);
    for (int loop=0;  loop < locationStr.length(); loop++ ){
    			Character c = locationStr.charAt(loop); 
...
public int compareTo(Location arg0) {
	...
	return   arg0.getnumRecords() - this.getnumRecords();
	//return 0;
}
}
